...
import com.vortexwolf.chan2.boards.makaba.MakabaApiReader;
import com.vortexwolf.chan2.boards.makaba.MakabaModelsMapper;
import com.vortexwolf.chan2.boards.makaba.MakabaUrlBuilder;
import com.vortexwolf.chan2.boards.makaba.MakabaUrlParser;
import com.vortexwolf.chan2.boards.makaba.MakabaWebsite;
import com.vortexwolf.chan2.common.library.ExtendedHttpClient;
import com.vortexwolf.chan2.common.library.ExtendedObjectMapper;
import com.vortexwolf.chan2.common.utils.CompatibilityUtilsImpl;
import com.vortexwolf.chan2.db.DvachSqlHelper;
import com.vortexwolf.chan2.db.FavoritesDataSource;
import com.vortexwolf.chan2.db.HiddenThreadsDataSource;
import com.vortexwolf.chan2.db.HistoryDataSource;
import com.vortexwolf.chan2.services.BitmapManager;
import com.vortexwolf.chan2.services.CacheDirectoryManager;
import com.vortexwolf.chan2.services.DvachCaptchaService;
import com.vortexwolf.chan2.services.HtmlCaptchaChecker;
import com.vortexwolf.chan2.services.IconsList;
import com.vortexwolf.chan2.services.MailruCaptchaService;
import com.vortexwolf.chan2.services.NavigationService;
import com.vortexwolf.chan2.services.PostSender;
import com.vortexwolf.chan2.services.SerializationService;
import com.vortexwolf.chan2.services.ThreadImagesService;
import com.vortexwolf.chan2.services.http.DownloadFileService;
import com.vortexwolf.chan2.services.http.HttpBitmapReader;
import com.vortexwolf.chan2.services.http.HttpBytesReader;
...
import com.vortexwolf.chan2.services.presentation.DraftPostsStorage;
import com.vortexwolf.chan2.services.presentation.OpenTabsManager;
import com.vortexwolf.chan2.services.presentation.PagesSerializationService;
